...
import com.supan.realmmigration.MigrationExampleActivity;
...
public class Migration implements RealmMigration {
    ...
    public void migrate(final DynamicRealm realm, long oldVersion, long newVersion) {
        ...
        ************************************************/
        ...
        if (oldVersion == 0) {
            Log.i(MigrationExampleActivity.TAG, "ekhane ashche 0 version e");
        ...
        if (oldVersion == 1) {
            Log.i(MigrationExampleActivity.TAG, "1 version e ashche");
            // Create a new class
        ...
        if (oldVersion == 2) {
            Log.i(MigrationExampleActivity.TAG, "now 2 version e ashche");
            RealmObjectSchema personSchema = schema.get("Person");
